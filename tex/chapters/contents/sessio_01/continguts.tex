\section{Què és tot això de la ciència?}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/telescopi_galileu.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/sidereus_nuncius_lluna.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{images/cern_accelerador_particules.jpg}
