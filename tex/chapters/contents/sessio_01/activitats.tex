...
\section{Sessió 01 (14/09/26). Quadern de laboratori: representar dades en una gràfica}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{model_pagina.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pas_01.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pas_final.png}
\end{figure}
...
10 & 0.0 \\
\end{tabular}
\captionof{table}{Muntanya russa.}
\end{minipage}
...
10 & 0.0 \\
\end{tabular}
\captionof{table}{Pilota voladora}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
\centering
...
10 & 1.0 \\
\end{tabular}
\captionof{table}{Palanca.}
\end{minipage}

\medskip

\subsubsection{Nivell II}
...
10 & 0.5 \\
\end{tabular}
\captionof{table}{Una bola que es refreda.}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
\centering
...
10 & 9.6 \\
\end{tabular}
\captionof{table}{Una mesura real.}
\end{minipage}
